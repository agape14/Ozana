...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-SKCSF13RP9"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-SKCSF13RP9');
    </script>
</head>
...
<body>
    ...
    <header class="header">
        ...
        <h2 class="d-none">Agua para ti, tu bienestar es lo primero</h2>
    </header>
    <!-- End of Main header -->